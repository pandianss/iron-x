...
const DisciplineIdentityCard: React.FC = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 relative overflow-hidden">
            ...
            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Discipline Status</h3>

            <div className="flex items-center justify-between">
                <div>
                    <div className="text-2xl font-bold text-gray-900">{data.classification.replace('_', ' ')}</div>
