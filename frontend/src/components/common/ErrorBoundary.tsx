...
export class ErrorBoundary extends Component<Props, State> {
    ...
    public render() {
        if (this.state.hasError) {
            return (
                <div className="min-h-screen flex items-center justify-center bg-iron-50 px-4 py-12 sm:px-6 lg:px-8 font-sans">
                    <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-iron-100">
                        <div className="text-center">
                            ...
                            <h1 className="text-2xl font-bold text-iron-900 mb-2">Engine Stall Detected</h1>
                            ...
                            <p className="mt-4 text-xs text-iron-400">
